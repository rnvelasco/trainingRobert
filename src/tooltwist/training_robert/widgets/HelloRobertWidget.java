package tooltwist.training_robert.widgets;
...
import tooltwist.training_robert.productionHelpers.HelloRobertProductionHelper;
 ...
 * Hello World Robert
 */
public class HelloRobertWidget extends WbdWidgetController
{
	private static final String SNIPPET_PREVIEW = "helloRobert_preview.html";
	private static final String SNIPPET_DESIGN = "helloRobert_design.html";
	private static final String SNIPPET_PRODUCTION = "helloRobert_production.jsp";
...
//TODO: Uncomment this as required
		...
		if (mode == GenerationMode.DESIGN)
		{
			...
			CodeInserter[] arr = {
				...
				new StylesheetCodeInserter(generator, instance, "helloRobert_cssHeader.css"),
			};
...
//				new StylesheetLinkInserter(cssUrl),
				...
				new JavascriptCodeInserter(generator, instance, "helloRobert_jsHeader.js"),
...
//				new PageImportCodeInserter(XData.class.getName()),
			...
			if (USE_PRODUCTION_HELPER)
			{
				...
				codeInserterList.add(WbdProductionHelper.codeInserter(instance, HelloRobertProductionHelper.class.getName(), productionHelperParams));
				codeInserterList.add(new PageImportCodeInserter(HelloRobertProductionHelper.class.getName()));
			}
		}
