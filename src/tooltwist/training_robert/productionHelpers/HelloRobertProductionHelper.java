package tooltwist.training_robert.productionHelpers;
...
public class HelloRobertProductionHelper extends WbdProductionHelper
{
	...
	public HelloRobertProductionHelper(Properties prop)
	{
		super(prop);
	}
